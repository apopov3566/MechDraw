    ...
    def update(self,face_msg):
        ...
        if maxface is not None and maxface.face.height > 50 and (len(maxface.eyes) > 0 or self.eye_misses < self.eye_thresh):
            with self.params_lock:
                ...
                self.facex = maxface.face.x + maxface.face.width/2 - self.cwidth / 2
                self.facey = maxface.face.y + maxface.face.height/2 - self.cheight / 2
...
def seek_goal(i, t):
    if i == 0:
        ...
        return math.pi / 6 * math.sin(t * SEEK_RATE)
