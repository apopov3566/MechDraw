...
def set_goal(m_msg):
    ...
    global t, m_params
    with params_lock:
        yaw = m_params[1]['cmdpos']
        yawvel = m_params[1]['cmdvel']
        pitch = m_params[0]['cmdpos']
        pitchvel = m_params[0]['cmdvel']
    setspline(0, m_msg.pitch, pitch, pitchvel, t)
    setspline(1, m_msg.yaw, yaw, pitchvel, t)
